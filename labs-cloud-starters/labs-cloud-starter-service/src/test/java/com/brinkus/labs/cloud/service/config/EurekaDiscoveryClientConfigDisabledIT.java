...
@ActiveProfiles("eureka-disabled")
public class EurekaDiscoveryClientConfigDisabledIT {
    ...
    public void eurekaClientDisabled() {
        assertThat(context.getBean(EurekaHealthCheckHandler.class), nullValue());
    }

...
@ActiveProfiles("eureka-enabled")
public class EurekaDiscoveryClientConfigEnabledIT {
    ...
    @Test
    public void eurekaClientEnabled() {
        assertThat(context.getBean(EurekaHealthCheckHandler.class), notNullValue());
    }
